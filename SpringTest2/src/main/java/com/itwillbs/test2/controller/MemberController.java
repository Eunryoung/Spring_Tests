...
//	}
	...
	@PostMapping("MemberJoinPro")
	public String joinPro(MemberBean member, 
			String jumin1, String jumin2, String postCode, String address1, String address2, String email1, String email2) {
//		System.out.println("이름(MemberBean) : " + member.getName());
//		System.out.println("아이디(MemberBean) : " + member.getId());
//		System.out.println("패스워드(MemberBean) : " + member.getPasswd());
...
//		System.out.println(member);
		// => hobby 배열타입 파라미터도 알아서 관리해줌!
		
		// MemberJoinProService - registMember() 메서드 호출하여 회원 가입 작업 요청
