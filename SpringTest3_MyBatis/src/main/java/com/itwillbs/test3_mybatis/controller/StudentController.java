...
//	private StudentService service;
	// 현재 클래스의 생성자를 정의하여 자동 주입받을 객체 타입 파라미터를 명시하면
...
//		System.out.println("이메일(Map) : " + map.get("email"));
//		System.out.println("학년(Map) : " + map.get("grade"));
//		return "";
//	}
...
//		return "redirect:/studentInfo?idx=" + idx;
